...
async def group(client, message):
    ...
    if 2 < len(message.text) < 50:    
        ...
        search = message.text
        result_txt = f"**•ᴍᴏᴠɪᴇ / sᴇʀɪᴇs : {search}**\n**•ᴄʜᴀɴɴᴇʟ : [ᴄɪɴᴇᴍᴀ ᴊᴀʟᴀᴋᴀᴍ](https://t.me/CJ_OFFICAlL)**\n**•ᴘᴏᴡᴇʀᴇᴅ ʙʏ : [ᴀᴅᴜ ᴛʜᴏᴍᴀ](https://t.me/CINEMA_JALAKAM_autofilter_BOT)**\n \n**©️ Cɪɴᴇᴍᴀ Jᴀʟᴀᴋᴀᴍ**"
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if (clicked == typed):
        ...
        if query.data.startswith("next"):
            ...
            buttons = [
                [
                    InlineKeyboardButton('Update Channel', url='https://t.me/CJ_OFFICAlL'),
            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        InlineKeyboardButton('More movies', url='https://t.me/CINEMA_JALAKAM'),
                        InlineKeyboardButton('Update Channel', url='https://t.me/CJ_OFFICAlL')
                    ]
                    ]
